...
while  contador < threshold:
    print(f'Generación: {contador}')
    print('Poblacion generada aleatoriamente:')
    print(P)
    # Convertir a decimal
    ...
    #Generar nueva pop e ingresar ind por cruza y pase directo
    ...
    i = 1
    print(f'Pasan directo: {n_pase_directo} individuos')
    ...
    # Calculo de promedio por iteracion
    ...
    print(f'Poblacion Nueva:\n{poblacionNueva}')
    print(f'En array: ↑ hay: {len(poblacionNueva)} individuos')
    contador += 1

# --------------> Graficación <--------------------
print("\nLista de fitness (promedios) despues de", contador, "iteraciones: \n")
print(fitnessPromedio)
r *= 100
m *= 100
